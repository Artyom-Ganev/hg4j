 ...
 */
public final class ErrorCollectorExt extends ErrorCollector {

    //TODO: MultipleFailureException is deprecated
    public void verify() throws Throwable {
        try {
            super.verify();
        } catch (MultipleFailureException ex) {
            ex.getFailures().forEach(Throwable::printStackTrace);
            throw ex;
        }
    }
