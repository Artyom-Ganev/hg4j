...
public final class RepoUtils {
    ...
    public static File initEmptyTempRepo(String dirName) throws IOException, HgException {
    ...
    public static File createEmptyDir(String dirName) throws IOException {
    ...
    public static File cloneRepoToTempLocation(String configRepoName, String name, boolean noupdate) throws HgException, IOException, InterruptedException {
        return cloneRepoToTempLocation(Configuration.get().find(configRepoName), name, noupdate);
    }

    public static File cloneRepoToTempLocation(HgRepository repo, String name, boolean noupdate) throws IOException, InterruptedException {
        return cloneRepoToTempLocation(repo.getWorkingDir(), name, noupdate, false);
    }

    public static File cloneRepoToTempLocation(File repoLoc, String name, boolean noupdate, boolean usePull) throws IOException, InterruptedException {
    ...
    public static File copyRepoToTempLocation(String configRepoName, String newRepoName) throws HgException, IOException {
    ...
    public static void modifyFileAppend(File f, Object content) throws IOException {
        assertTrue(f.isFile());
    ...
    public static void createFile(File f, Object content) throws IOException {
        if (content == null) {
            f.createNewFile();
            return;
        }
    ...
    public static void exec(File wd, int expectedRetVal, String... args) throws Exception {
    ...
    public static Nodeid[] allRevisions(HgRepository repo) {
    ...
    public static void assertHgVerifyOk(ErrorCollectorExt errorCollector, File repoLoc) throws InterruptedException, IOException {
